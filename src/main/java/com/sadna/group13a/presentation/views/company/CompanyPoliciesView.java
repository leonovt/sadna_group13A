...
@PageTitle("Company Purchase & Discount Policies")
public class CompanyPoliciesView extends VerticalLayout implements BeforeEnterObserver {

    private final CompanyPoliciesPresenter presenter;
    ...
    public CompanyPoliciesView(CompanyPoliciesPresenter presenter) {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        initView();
        presenter.handleLoadCurrentPolicies(companyId, this);
    }
    ...
    private void initView() {
        ...
        add(new Button("← Back to Dashboard", e -> presenter.handleBack(companyId)));

        statusMessage.setVisible(false);
        statusMessage.getStyle().set("font-weight", "bold");

        add(new H2("Purchase & Discount Policies"), statusMessage);
    ...
    private VerticalLayout buildPurchasePolicySection() {
        ...
        Button applyBtn = new Button("Apply Purchase Policy", e -> {
            ...
            presenter.handleSetPurchasePolicy(companyId, new ArrayList<>(purchaseRules), mode, this);
        });
    ...
    private VerticalLayout buildDiscountPolicySection() {
        ...
        Button applyBtn = new Button("Apply Discount Policy", e -> {
            ...
            presenter.handleSetDiscountPolicy(companyId, new ArrayList<>(discountRules), mode, this);
        });
    ...
    public void showSuccess(String message) {
        ...
        statusMessage.setVisible(true);
        // Reload the current-policy display after a successful apply
        presenter.handleLoadCurrentPolicies(companyId, this);
    }
